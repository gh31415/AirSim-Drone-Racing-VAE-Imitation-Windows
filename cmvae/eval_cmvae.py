...
data_dir = 'E:/AirSim-Drone-Racing-VAE-Imitation/airsim_datasets/soccer_test'
read_table = True
latent_space_constraints = True
weights_path = 'E:/AirSim-Drone-Racing-VAE-Imitation/model_outputs/cmvae_con_train/cmvae_model_45.ckpt'
...
for i in range(1, num_imgs_display + 1):
    ...
    plt.axis('off')
    plt.imshow(img_display)
fig.savefig(os.path.join('E:/AirSim-Drone-Racing-VAE-Imitation/Pictures', 'reconstruction_results.png'))
plt.show()
...
plt.axis('off')
plt.imshow(img_display)
fig2.savefig(os.path.join('E:/AirSim-Drone-Racing-VAE-Imitation/Pictures', 'reconstruction_interpolation_results.png'))
plt.show()
...
for i in range(1, z_num_mural * n_z + 1):
    ...
    plt.axis('off')
    plt.imshow(img_display)
fig3.savefig(os.path.join('E:/AirSim-Drone-Racing-VAE-Imitation/Pictures', 'z_mural.png'))
plt.show()
